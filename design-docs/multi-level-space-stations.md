...
### **Vision Statement**
Transform Ironblast from simple horizontal scrolling to strategic multi-layered combat with **3D-depth targeting** in a 2D environment. Players can attack different "floors" or "decks" of massive space stations while maintaining classic Ironblast movement mechanics.
...
- **Layer 1 (Lower)**: **NORMAL** - Standard Ironblast scrolling mechanics
