...
class NormalTop10Screen:
    ...
    def handle_and_draw(self, screen, bg_scaled, top10_list, menu_ref, came_from='menu', source_label=None):
        """
        ...
        if source_label:
            ...
            source_rect = source_text.get_rect(center=(cw // 2, int(130 * ui_scale)))
